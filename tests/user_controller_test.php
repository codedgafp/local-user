...
class local_user_controller_testcase extends advanced_testcase {
    ...
    public function test_set_user_preference() {
        ...
        // Not preference.
        self::assertFalse($DB->record_exists('user_preferences', ['userid' => $user->id]));
        ...
        // New preference.
        self::assertTrue($DB->record_exists('user_preferences', ['userid' => $user->id]));

        // Get preference.
        $userpreference = $DB->get_records('user_preferences', ['userid' => $user->id]);
