        ...
        try {
            switch ($action) {
                ...
                case 'get_roles' :
                    ...
                    $data->order = is_null($order) ? null : $order[0];
                    ...
                    $data->start = $this->get_param('start', PARAM_INT, 0);
                ...
                case 'set_user_preference' :
                    ...
                    return $this->success($this->set_user_preference($userid, $preferencename, $value));

                default:
                    $userid = $this->get_param('userid', PARAM_INT);
                    return $this->success($this->$action($userid));
            }
