...
/**
 * Never logged user deleted task.
 *
 * @package    local_user
 ...
 */
class never_logged_user_deleted extends \core\task\scheduled_task {
    /**
    ...
    public function get_name() {
        ...
        return get_string('task_never_logged_user_deleted', 'local_user');
    }
    ...
    public function execute() {
        ...
        // Get users.
        $users = $this->dbi->get_never_logged_user_for_giver_day($lasttime);
